...
using StockLink.Application.UseCase.UseCase.CarritoCompra.Commands.DeleteByVendedorCommand;
using StockLink.Application.UseCase.UseCase.CarritoCompra.Commands.DeleteCommand;
using StockLink.Application.UseCase.UseCase.CarritoCompra.Commands.UpdateCommand;
using StockLink.Application.UseCase.UseCase.CarritoCompra.Queries.GetAllQueryByVendedor;
