...
using ValidationException = StockLink.Application.UseCase.Commons.Exceptions.ValidationException;

namespace StockLink.Application.UseCase.Commons.Behaviours
{
